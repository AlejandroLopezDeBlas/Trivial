...
public class Game {
    ...
    private void hacerPregunta() {
        ...
        if (categoriaActual() == "Cultura popular")
            System.out.println(preguntasCultura.get(randomNumber.nextInt(50)));
        if (categoriaActual() == "Ciencias")
            System.out.println(preguntasCiencias.get(randomNumber.nextInt(50)));
        if (categoriaActual() == "Deportes")
            System.out.println(preguntasDeportes.get(randomNumber.nextInt(50)));
        if (categoriaActual() == "Música")
            System.out.println(preguntasMusica.get(randomNumber.nextInt(50)));
    }
    ...
    public boolean fueRespuestaCorrecta() {
        if (enCasillaCastigo[jugadorActual]) {
            if (estaSaliendoDeLaCarcel) {
                respuestaCorrectaMasMonedasDoradas();
    ...
    private void respuestaCorrectaMasMonedasDoradas() {
